    ...
    <div className="flex items-center gap-2">
      {isEditing ? (
        <form className="relative w-fit max-w-[50ch]" onSubmit={handleSubmit}>
          <span className="invisible whitespace-pre inset-0 text-lg text-black truncate px-1.5">
            {value ?? " "}
          </span>
          <input
            ref={inputRef}
            ...
            className="absolute inset-0 text-lg text-black bg-transparent truncate px-1.5"
          />
        </form>
      ) : (
        <span
